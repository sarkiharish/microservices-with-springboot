...
import com.hari.microdemo.entity.EmployeeEntity;
import com.hari.microdemo.error.EmployeeNotFoundException;
import com.hari.microdemo.model.Employee;
import com.hari.microdemo.repository.EmployeeRepository;
...
public class EmployeeV2ServiceImpl implements EmployeeService{
    ...
    public Employee getEmployeeById(String id) {
        ...
        EmployeeEntity entity = employeeRepository.findById(id).orElseThrow(() -> new EmployeeNotFoundException("Employee not found with id : " + id));
        Employee employee = new Employee();
